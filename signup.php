            ...
            <form  action="signup_script.php" method="POST">
                <div class="row">
                    ...
                    <div class="input-group col-lg-6 mb-4">
                        ...
                        <input id="firstName" type="text" name="f_name" placeholder="First Name" class="form-control bg-white border-left-0 border-md" pattern="[A-Za-z-0-9]+\s[A-Za-z-'0-9]+" required>
                    </div>
                    ...
                    <div class="input-group col-lg-6 mb-4">
                        ...
                        <input id="l_name" type="text" name="lastname" placeholder="Last Name" class="form-control bg-white border-left-0 border-md"pattern="[A-Za-z-0-9]+\s[A-Za-z-'0-9]+" required>
                    </div>
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="phoneNumber" type="tel" name="p_no" placeholder="Phone Number" class="form-control bg-white border-md border-left-0 pl-3"pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}">
                        <?php
                                if(isset($_GET["m2"])){
                                  echo $_GET['m2'];
                                }
                    ...
                    <div class="input-group col-lg-6 mb-4">
                        ...
                        <input id="pswd2" type="text" name="passwordConfirmation" placeholder="Confirm Password" class="form-control bg-white border-left-0 border-md">
                    </div>
